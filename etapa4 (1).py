...
# Tipos de documento que contam como proposta — mesma lista que a Etapa 1 usa
# pra detectar propostas. Inclui a combinada (técnica + comercial no mesmo
# arquivo); o prompt foca só na ótica técnica.
TIPOS_PROPOSTA = {"proposta_combinada", "proposta_tecnica", "proposta_comercial"}


def _propostas(estudo) -> list:
    """Documentos classificados como proposta (combinada, técnica ou comercial)."""
