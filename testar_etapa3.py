"""
testar_etapa3.py — Entrypoint pra testar Etapas 1, 2 e 3 em sequência.

Rode com:
    streamlit run testar_etapa3.py
"""
...
st.set_page_config(page_title="Etapas 1-3 — Teste", layout="wide")
st.title("Analisador de Propostas — Etapas 1, 2 e 3")
st.caption("Classificação → Baseline → Edital Técnico")
...
st.progress(passo / 4, text=f"Passo {passo} de 4")
...
# RESUMO FINAL
# -----------------------------------------------------------------------
if st.session_state.etapa3_resultado:
    st.success("Etapas 1, 2 e 3 concluídas. Pronto pra Etapa 4.")
